...
description: >-
  Apply distinctive, non-generic frontend design rules for landing pages,
  promotional surfaces, and UI layouts. Use when doing frontend design tasks,
  building or restyling UI, creating landing/hero sections, choosing typography
  or color, or when the user mentions design, visual polish, branding, or layout.
---
...
- **React:** Prefer modern patterns including useEffectEvent, startTransition, and useDeferredValue when appropriate if used by the team. Do not add useMemo/useCallback by default unless already used; follow the repo's React Compiler guidance.
